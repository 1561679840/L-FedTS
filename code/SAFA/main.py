...
from models import Mnist_Model, Boston_Model, KDD_Model, CIFAR_Model_ZFNet
    ...
    for epoch in tqdm(range(args.epochs)):
        if epoch == 0:
            ...
            if count_round % 5 == 0:
                ...
                with open("record.txt", 'a') as f:
                    f.write(
                        f"\nepoch:{epoch},accuracy:{avg_acc},loss:{loss},pick_len:{len(pick_client_id)},pick:{pick_client_id},undraft:{undraft_client_id},time:{now_time}")
